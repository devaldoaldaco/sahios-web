      ...
      <footer>
        ...
        <section class="bottom-section">
          <section class="left-section">
            <h3>Empezar</h3>
            <ul>
              <li tabindex="1">Productos</li>
              <li tabindex="1">Servicios</li>
              <li tabindex="1">Acerca de nosotros</li>
              <li tabindex="1"></li>
            </ul>
          </section>
          ...
          <section class="right-section">
            <h3>Ayuda</h3>
            <ul>
              <li tabindex="1">FAQS</li>
              <li tabindex="1">Term & Conditions</li>
              <li tabindex="1">Policy & Privacy</li>
              <li></li>
            </ul>
          </section>
        </section>
